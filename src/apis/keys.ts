...
export default class Keys {
  ...
  async export(
    ...
    if (placeholderFormat) params.append("placeholderFormat", placeholderFormat);
  ...
  async import(
    ...
    convertPlaceholders && formData.set("convertPlaceholders", convertPlaceholders.toString());
